...
public class TestMapper extends AbstractTestNGSpringContextTests {
    ...
    public void createEntities(){
        ...
        this.dogDTO = new DogDTO("Cody", "Golden Retriever", new Date(2016,1,22), Gender.MALE, null);
    ...
    private List<DogDTO> initializeDogDTOs(){
        DogDTO dog1 = new DogDTO("Cody", "Golden Retriever", new Date(2016,1,22), Gender.MALE, null);
        DogDTO dog2 = new DogDTO("Boby", "GodKnows", new Date(1996,4,4), Gender.MALE, null);
        DogDTO dog3 = new DogDTO("Connor", "Border Collie", new Date(2015,11,23), Gender.MALE, null);
